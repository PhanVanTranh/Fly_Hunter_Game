...
#define STEP_SETTING_CHOSSE 					(1)

#define SETTING_ITEM_ARRDESS_0					(255) 
#define SETTING_ITEM_ARRDESS_1					(0)   // Arrows
#define SETTING_ITEM_ARRDESS_2					(1)   // Fly speed
#define SETTING_ITEM_ARRDESS_3					(2)   // Silent
#define SETTING_ITEM_ARRDESS_4					(3)   // EXIT

#define CYBER_ICON_W                            (12)
#define CYBER_ICON_H                            (12)
